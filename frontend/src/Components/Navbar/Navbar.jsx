...
const discountedPrice = cartItems.discountedPrice
.toFixed(2)
.toString()
.replace(/\B(?=(\d{3})+(?!\d))/g, ",");
...
<div>
  {
    location.pathname!=="/checkout" &&   <div className="z-50 relative fontStyle -top-2  pt-7 px-7">
    <div
      className={` ${
        ...
        <div className="text-white  group cursor-pointer  py-2 ">
          <div className="flex items-center  space-x-2 relative">
            ...
            <div className="bg-white absolute top-10 text-black -left-80 opacity-0  group-hover:opacity-100 transition-opacity duration-300 pointer-events-none group-hover:pointer-events-auto p-4">
              <div className="flex space-x-4 text-gray-600 pb-4 border-b border-black ">
                <div className="w-[100px] h-[100px] ">
                  <img className="w-full h-full object-contain" src={cartItems.images[0]} alt="" />
                </div>
                <div>
                  <div className="flex items-center space-x-2">
                  <p className="w-[150px] h-[24px] overflow-hidden">{cartItems.name}</p>
                  <p className="font-bold text-black">Rs.{discountedPrice}</p>
                  </div>
                  <p>{cartItems.brand}</p>
                  <p>Size: S</p>
                  <p>Qty: 1</p>
              ...
              <div className="mt-3 pb-2 border-b border-black">
                <div className="flex items-center justify-between text-lg font-semibold pr-16">
                  <p>Shipping</p>
                  <p>Rs. 0.00</p>
                </div>
                <div className="flex items-center justify-between text-lg font-semibold mt-2 pr-10">
                  <p>Subtotal</p>
                  <p>Rs.{discountedPrice}</p>
                </div>
              </div>
              <div className="flex items-center justify-around mt-4">
                <Link to="/shoping-cart" className="text-white bg-black hover:bg-white hover:text-black border font-semibold px-10 py-1.5">View Cart</Link>
                <Link to="/checkout" className="text-white hover:text-black hover:bg-white border bg-[#ed1c24] font-semibold px-10 py-1.5">Checkout</Link>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="flex items-center justify-end text-white space-x-20">
        ...
        <div className="text-black  group cursor-pointer  py-2 ">
          <div className="flex items-center  space-x-2 relative">
            ...
            <div className="bg-white absolute top-10 border text-black -left-80 opacity-0  group-hover:opacity-100 transition-opacity duration-300 pointer-events-none group-hover:pointer-events-auto p-4">
              <div className="flex space-x-4 text-gray-600 pb-4 border-b border-black ">
                <div className="w-[100px] h-[100px] ">
                  <img className="w-full h-full object-contain" src={cartItems.images[0]} alt="" />
                </div>
